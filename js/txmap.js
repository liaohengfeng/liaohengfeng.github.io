...
$.ajax({
    ...
    data: {
        key: 'NJCBZ-NB3RU-GSDVC-GRDQJ-I3V5F-UXFHA',
        output: 'jsonp',
    },
    dataType: 'jsonp',
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(106.45773, 29.54098, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
            ...
            document.getElementsByClassName("announcement_content")[0].innerHTML =
                `&ensp;&ensp;&ensp;&ensp;欢迎来自<span> ${pos} </span>的小伙伴，${timeChange}<br>
        &ensp;&ensp;&ensp;&ensp;你距离MYLHF约有<span>${dist}</span>公里，${posdesc}
        `;
        }
        showWelcome()
    }
